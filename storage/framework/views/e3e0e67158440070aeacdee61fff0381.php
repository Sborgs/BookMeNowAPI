...
<body>
    <header id="cabecalho" class="container">
        ...
        <div id="logotipo">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="BookMeNow" height="40">
        </div>
        ...
        <div id="botaoTopo">
            <a href="<?php echo e(route('login.form')); ?>" class="btn-secundario">Login</a>
    ...
    <footer id="rodape">
        <div class="container" id="linha-rodape">
            ...
            <div class="coluna-rodape">
                ...
                <div class="link-app">
                    <img src="<?php echo e(asset('img/google-play.png')); ?>" alt="Baixe nosso APP Google play">
                    <img src="<?php echo e(asset('img/app-store.png')); ?>" alt="Baixe nosso APP Apple Store">
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\bookmenowapi\resources\views/layouts/site.blade.php ENDPATH**/ ?>